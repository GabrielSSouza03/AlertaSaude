...
# App title
st.set_page_config(page_title="Alerta Saúd📍", page_icon=":heavy_heart_exclamation_mark_ornament:")


# Initialize Gemini-Pro 
genai.configure(api_key="AIzaSyAYvjQlobixvml__FVS6NTut5ksyoLg1lA")
generation_config = {
